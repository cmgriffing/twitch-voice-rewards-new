...
export const availablePrompts: {
  ...
  },
  {
    ...
    promptText:
      "Imagine the user as a Sports Star. Decide what sport they play. Also describe their greatest play for that sport and create any other milestones that make sense. Try to avoid common sports like basketball or soccer. Try to opt for obscure sports or even made up sports.",
  },
